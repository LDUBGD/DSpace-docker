...
WRITE_ENV_FILE=""
PAYLOAD_SECRET_KEY="DSPACE_APP_ENV_PAYLOAD_SECRET_NAME"
GENERATED_SECRET_KEYS=(
  DSPACE_APP_ENV_PAYLOAD_SECRET_NAME
  DSPACE_POSTGRES_PASSWORD_SECRET_NAME
)
PRINT_EXPORT=false
PAYLOAD_TMP=""
SECRET_TMP_FILES=()
...
render_value_secret() {
  ...
  value_tmp="$(mktemp "${TMPDIR:-/tmp}/dspace-secret-value.XXXXXX")"
...
render_value_secret \
  POSTGRES_PASSWORD \
  DSPACE_POSTGRES_PASSWORD_SECRET_NAME \
  "${DSPACE_POSTGRES_PASSWORD_SECRET_BASE:-dspace_postgres_password}" \
  "PostgreSQL password secret"

PAYLOAD_TMP="$(mktemp "${TMPDIR:-/tmp}/dspace-env-payload.XXXXXX")"
...
payload_secret_base="${DSPACE_APP_ENV_PAYLOAD_SECRET_BASE:-${RUNTIME_ENV_SECRET_BASE:-dspace_app_env_payload}}"
